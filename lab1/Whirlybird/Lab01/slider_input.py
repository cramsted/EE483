...
class Sliders:
    ...
    def __init__(self):
        ...
        # SECTION 1
        ###############################################################
        self.num_of_sliders = 3 # The number of Slider objects that
        ...
        self.Sphi = mySlider(num_of_sliders = self.num_of_sliders,
            slider_number = 1, maxV = 90,minV = -90,intV =0,
            gain = np.pi/180, name ='phi/pitch')
        self.Stheta = mySlider(num_of_sliders = self.num_of_sliders,
            slider_number = 2, maxV = 90,minV = -90,intV =0,
            gain = np.pi/180, name ='theta/roll')
        self.Spsi = mySlider(num_of_sliders = self.num_of_sliders,
            slider_number = 3, maxV = 90,minV = -90,intV =0,
            gain = np.pi/180, name ='psi/yaw')
    ...
    def getInputValues(self):
        ...
        # SECTION 3
        ################################################################
        values = [self.Sphi.getValue(), self.Stheta.getValue(), self.Spsi.getValue()]
        ################################################################
        return values
